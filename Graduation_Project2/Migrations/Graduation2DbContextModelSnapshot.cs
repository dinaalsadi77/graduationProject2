...
namespace Graduation_Project2.Migrations
{
    ...
    partial class Graduation2DbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Graduation_Project2.Models.AllSchedule", b =>
                {
                    b.Property<int>("AllScheduleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("AllScheduleId");

                    b.HasIndex("doctorAdminId")
                        .IsUnique();

                    b.ToTable("allSchedules");
                });
            ...
            modelBuilder.Entity("Graduation_Project2.Models.AllSchedule", b =>
                {
                    b.HasOne("Graduation_Project2.Models.DoctorAdmin", "doctorAdmin")
                        .WithOne("allSchedule")
                        .HasForeignKey("Graduation_Project2.Models.AllSchedule", "doctorAdminId")
                        .IsRequired();
            ...
            modelBuilder.Entity("Graduation_Project2.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("Graduation_Project2.Models.Schedule", "schedule")
                        .WithOne("appointment")
                        .HasForeignKey("Graduation_Project2.Models.Appointment", "scheduleId")
                        .IsRequired();
            ...
            modelBuilder.Entity("Graduation_Project2.Models.Schedule", b =>
                {
                    b.HasOne("Graduation_Project2.Models.AllSchedule", "allSchedule")
                        .WithMany("schedules")
                        .HasForeignKey("AllScheduleId")
                        .IsRequired();

                    b.Navigation("allSchedule");
                });
